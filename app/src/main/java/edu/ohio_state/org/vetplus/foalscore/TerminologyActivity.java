 ...
 */
public class TerminologyActivity extends Activity {
    private WebView webView;
    private TerminologyTask ref = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isInternetPresent) {
            ...
            AlertDialog dialog = new AlertDialog.Builder(new ContextThemeWrapper(TerminologyActivity.this, R.style.Base_V7_Theme_AppCompat_Dialog))
                    .setTitle("No Active Internet Connection.")
                    .setMessage("Please connect to the Internet and try again.")
                    .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            // continue with delete
                            Intent homepage = new Intent(TerminologyActivity.this, OverviewActivity.class);
    ...
    public void loadContent() {
        ...
        ref = new TerminologyTask();
        ref.execute();
    }

           public class TerminologyTask extends AsyncTask<Void, Void, Boolean> {
            ...
            protected Boolean doInBackground(Void... params) {
                ...
                HttpGet httpget = new HttpGet("http://foalscore.org.ohio-state.edu/foalscore/server/contents/terminology.json");
                ...
                try {
                    ...
                    Log.i("Terminology", "Response Text: " + responseText);
                    JSONObject json = new JSONObject(responseText);
                    String status = json.getString("status");
                    Log.i("Terminology","Status: " + status);
                    if(status.equals("success")) {
                        // Log.i("LoginActivity","");
                        refText = "<html>" +
                                "<head>" +
                                "</head>" +
                                "<body style=\"text-align:justify\"><div style = 'padding: 4px;'>" + json.getString("text") + "</div></body></html>";
