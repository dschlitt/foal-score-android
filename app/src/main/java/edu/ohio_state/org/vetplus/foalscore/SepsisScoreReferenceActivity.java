 ...
 */
public class SepsisScoreReferenceActivity extends Activity {

    private WebView webView;
    private SepsisScoreReferenceTask ref = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sepsis_score_reference);
        ...
        if (isInternetPresent) {
            ...
            AlertDialog dialog = new AlertDialog.Builder(new ContextThemeWrapper(SepsisScoreReferenceActivity.this, R.style.Base_V7_Theme_AppCompat_Dialog))
                    .setTitle("No Active Internet Connection.")
                    .setMessage("Please connect to the Internet and try again.")
                    .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            // continue with delete
                            Intent homepage = new Intent(SepsisScoreReferenceActivity.this, OverviewActivity.class);
    ...
    public void loadContent() {
        ...
        ref = new SepsisScoreReferenceTask();
        ref.execute();
    }

    public class SepsisScoreReferenceTask extends AsyncTask<Void, Void, Boolean> {

        private String refText = "";
        private String errorMsg = "Server Error.";

        SepsisScoreReferenceTask() {
        }
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            HttpGet httpget = new HttpGet("http://foalscore.org.ohio-state.edu/foalscore/server/contents/sepsisscore.json");
