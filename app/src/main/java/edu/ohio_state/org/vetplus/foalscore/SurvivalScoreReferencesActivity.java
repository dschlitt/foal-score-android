 ...
 */
public class SurvivalScoreReferencesActivity extends Activity {
    private SurvivalScoreReferenceTask ref = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_survival_score_reference);
        ...
        webView = (WebView) findViewById(R.id.survivalScore);
        ...
        if (isInternetPresent) {
            ...
            AlertDialog dialog = new AlertDialog.Builder(new ContextThemeWrapper(SurvivalScoreReferencesActivity.this, R.style.Base_V7_Theme_AppCompat_Dialog))
                    .setTitle("No Active Internet Connection.")
                    .setMessage("Please connect to the Internet and try again.")
                    .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            // continue with delete
                            Intent homepage = new Intent(SurvivalScoreReferencesActivity.this, OverviewActivity.class);
    ...
    public void loadContent() {
        ...
        ref = new SurvivalScoreReferenceTask();
        ref.execute();
    }

    public class SurvivalScoreReferenceTask extends AsyncTask<Void, Void, Boolean> {

        private String refText = "";
        private String errorMsg = "Server Error.";

        SurvivalScoreReferenceTask() {
        }
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            HttpGet httpget = new HttpGet("http://foalscore.org.ohio-state.edu/foalscore/server/contents/survivalscore.json");
