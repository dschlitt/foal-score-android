 ...
 */
public class ImportantInformationActivity extends Activity {
    private ImportantInfoTask ref = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isInternetPresent) {
            ...
            AlertDialog dialog = new AlertDialog.Builder(new ContextThemeWrapper(ImportantInformationActivity.this, R.style.Base_V7_Theme_AppCompat_Dialog))
                    .setTitle("No Active Internet Connection.")
                    .setMessage("Please connect to the Internet and try again.")
                    .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            // continue with delete
                            Intent homepage = new Intent(ImportantInformationActivity.this, OverviewActivity.class);
    ...
    public void loadContent() {
        ...
        ref = new ImportantInfoTask();
        ref.execute();
    }

    public class ImportantInfoTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            HttpGet httpget = new HttpGet("http://foalscore.org.ohio-state.edu/foalscore/server/contents/overview.json");
